...
```
php composer.phar require "gromovfjodor/yii2-image-manager" "*" 
```
or add

```json
"gromovfjodor/yii2-image-manager" : "*"
```
...
```
yii migrate --migrationPath=@gromovfjodor/imagemanager/migrations
```
